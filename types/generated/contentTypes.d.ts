...
export interface ApiCartItemCartItem extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    milkTea: Schema.Attribute.Relation<
      'oneToOne',
      'api::milk-tea-and-coffee.milk-tea-and-coffee'
    >;
    ...
    sweetness: Schema.Attribute.String;
    toppings: Schema.Attribute.Relation<'oneToMany', 'api::topping.topping'>;
...
export interface ApiMilkTeaAndCoffeeMilkTeaAndCoffee
  extends Struct.CollectionTypeSchema {
  collectionName: 'milk_tea_and_coffees';
  info: {
    displayName: 'MilkTeaAndCoffee';
    pluralName: 'milk-tea-and-coffees';
    singularName: 'milk-tea-and-coffee';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::order.order'> &
      Schema.Attribute.Private;
    orderTime: Schema.Attribute.DateTime;
